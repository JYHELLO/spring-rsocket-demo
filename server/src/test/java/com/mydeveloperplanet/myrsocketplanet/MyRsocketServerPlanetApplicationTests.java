...
class MyRsocketServerPlanetApplicationTests {
    ...
    @BeforeAll
    public static void setupOnce(@Autowired RSocketRequester.Builder builder, @Value("${spring.rsocket.server.port}") Integer port, @Value("${spring.rsocket.server.mapping-path}") String mappingPath) {
